...
import '../../../updated_ui/utils/ui_utils.dart';
...
class PlayerMainControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double y =  Responsive.isMobile(context)
            ? AppConsts.pageSize(context).width - 86
            : 0;
    ...
    return AnimatedContainer(
      ...
      width: Responsive.isMobile(context) ? AppConsts.pageSize(context).width : AppConsts.pageSize(context).width/2.5,
      child: SizedBox(
        child: Column(
